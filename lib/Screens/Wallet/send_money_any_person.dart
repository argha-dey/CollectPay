...
class SendMoneyAnyPersonPage extends StatefulWidget {
   ...
   const SendMoneyAnyPersonPage({Key key,this.userContactData}) : super(key: key);
  @override
...
class _SendMoneyAnyPersonPageState extends State<SendMoneyAnyPersonPage> {
  ...
  Future<void> sendMoneyApi() async {
    ...
    Map<String, String> _requestBody = <String, String>{
      'from_id':fromUserId,
      'to_id': widget.userContactData.userId.toString(),
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Container(
                child: Text(
                  "Paying To "+widget.userContactData.name.toUpperCase(),
              ...
              Container(
                child: Text(
                  widget.userContactData.mobile.toUpperCase(),
                  style: CustomTextStyle.textFormFieldBold
