...
class RechargeDonePage extends StatefulWidget {
  @override
  _RechargeDonePageState createState() => _RechargeDonePageState();
}

class _RechargeDonePageState extends State<RechargeDonePage> {
