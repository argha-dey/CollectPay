...
class ActiveOrderHistoryPage extends StatefulWidget {

  const ActiveOrderHistoryPage({Key key}) : super(key: key);

  @override
  _ActiveOrderHistoryPageState createState() => new _ActiveOrderHistoryPageState();
}

class _ActiveOrderHistoryPageState extends State<ActiveOrderHistoryPage>  {
...
/*
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          Row(
                              ...
                              children: <Widget>[
                                Text(
                                  orderData[index].orderDisplayId,
                                  style: CustomTextStyle.textFormFieldSemiBold
                                      .copyWith(color:Colors.black,fontSize: 18),
                                ),
                                Text(
                                  orderData[index].orderStatus.toUpperCase(),
                                  style: CustomTextStyle.textFormFieldSemiBold
  ...
  InkWell(
          onTap: () {
                      Navigator.of(context).push(new MaterialPageRoute(
                          builder: (context) => MyOrderDetailsPage(orderId:orderData[index].orderId.toString())));
